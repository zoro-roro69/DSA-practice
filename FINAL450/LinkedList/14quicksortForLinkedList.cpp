...
Node * partition(Node * &head){//returns pivot node
    if (head == NULL)  
        return NULL;
    
    Node *pivot = getLastNode(head);
    Node *tail = pivot;
...
Node *previousNode(Node *head, Node *node){
    Node *cur = head;
...
Node *quickSort(Node * &head){
    ...
    // cout << "pivot:" << pivot->data << "  head::" << head->data <<endl;
    quickSort(pivot->next);
    if (head != pivot){
        Node *prev_pivot = previousNode(head, pivot);
        // cout <<"prev::::" << prev_pivot->data << endl;
...
int main(){
    ...
    printList(head);
    // Node * p = partition(head); cout << p->data << endl;
    quickSort(head);
    printList(head);
